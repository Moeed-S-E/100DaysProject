...
//
//import app.obj.Bullet;
//import app.obj.Effect;
//import app.obj.Player;
//import app.obj.Rocket;
//import app.obj.sound.Sound;
...
//            int grow = 30;
//            int bottom = 30;
//            g2.fill(new Rectangle2D.Double(x - grow, y - grow, textWidth + grow * 2, textHeight + grow * 2 + bottom));
//
//            g2.setColor(Color.WHITE);
...
//            g2.setColor(new Color(255, 255, 255, 10));
//            int grow = 30;
//            g2.fill(new Rectangle2D.Double(x - grow, y - grow, textWidth + grow * 2, textHeight + grow * 2));
//            g2.setColor(Color.WHITE);
//            g2.drawString(text, (int) x, (int) y + fm.getAscent());
//        }
//    }
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_LEFT) {
                    ...
                    key.setKey_space(true);  // Speed up
                } else if (e.getKeyCode() == KeyEvent.VK_SPACE) {
                    key.setKey_j(true);  // Shoot small bullets
                } else if (e.getKeyCode() == KeyEvent.VK_K) {
                    key.setKey_k(true);  // Shoot larger bullets
                } else if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    key.setKey_enter(true);
                } else if (e.getKeyCode() == KeyEvent.VK_ESCAPE) {
                    if (start && player.isAlive()) {
